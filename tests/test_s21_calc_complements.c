...
START_TEST(empty) {
    matrix_t a = {0};
    matrix_t b = {0};
    ck_assert_int_eq(s21_calc_complements(&a, &b), INCORRENTLY);
    s21_remove_matrix(&a);
    s21_remove_matrix(&b);
}
END_TEST
...
START_TEST(test6) {
    ...
    matrix_t expected = {0};
    s21_create_matrix(size, size, &expected);
    expected.matrix[0][0] = 503.283000;
    expected.matrix[0][1] = -3542.913000;
    expected.matrix[0][2] = -311.245000;
    expected.matrix[1][0] = 75.336910;
    expected.matrix[1][1] = -530.342010;
    expected.matrix[1][2] = -311.998390;
    expected.matrix[2][0] = 286.311330;
    expected.matrix[2][1] = -933.342430;
    expected.matrix[2][2] = -421.448770;
